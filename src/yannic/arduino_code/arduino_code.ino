...
int cur_pos[4]={0,0,0,0};

Servo servo1,servo2,servo3,servo4;

float readservo1=0,readservo2=0,readservo3=0,readservo4=0;
...
void servo_cb( const rospy_tutorials::Floats& cmd_msg){
  ...
  int new_pos[4]={cmd_msg.data[0],cmd_msg.data[1],cmd_msg.data[2],cmd_msg.data[3]};
  int i=0;
...
void callback(const yannic_robot::Floats_array::Request & req, yannic_robot::Floats_array::Response & res)
{
  ...
  res.res[3]=(readservo3-90) * (180.0/270.0);  //to be determined
  return;
